...
function multiply(number1, number2) {
  ...
  var response = 'The product of ' + number1 + ' and ' + number2 + ' is ' + product + '.';
...
function sumAndMultiply(x,y,z){ //eslint-disable-line
  ...
  var e1 = sum (x,y)[0];
  console.log(e1)
  var firstElement = sum (e1, z)[0];
  console.log('this is the final first element', firstElement);
  var e2 = multiply (x,y)[0];
  var secondElement = multiply (e2, z)[0];
  console.log('this is the final secondelement', secondElement);
  var thirdElement = x + ' and ' + y + ' and ' + z + ' sum to ' + firstElement + '.';
  var fourthElement = 'The product of ' + x + ' and ' + y + ' and ' + z + ' is ' + secondElement + '.';
  return [firstElement, secondElement, thirdElement, fourthElement]
}

sumAndMultiply(10,1,5);
